    ...
    sendJson(res, 200, {
      ...
      capabilities: {
        ...
        reusableComponents: {
          ...
          migrationOperationalHistory: true,
          migrationInterruptedBatchDetection: true,
          migrationPerDesignDiffInspection: true,
          migrationDiffIncludesComponentProvenance: true,
          migrationRecoveryAsNewRevision: true,
          migrationRecoveryCurrentTruthQa: true,
          migrationRecoveryApprovedAcknowledgement: true,
          migrationRecoveryPreservesOldApproval: true,
          migrationRecoveryAuditImmutable: true,
          extraModelCalls: 0,
        },
