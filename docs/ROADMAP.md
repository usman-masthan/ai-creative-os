...
- [ ] Add OpenAI strategy/copy adapter
- [ ] Add Claude critique adapter
- [ ] Add getimg.ai draft-image adapter
- [ ] Add premium image adapter
- [ ] Add Runway video adapter
- [ ] Add Veo video adapter
- [ ] Add provider cost estimation
- [ ] Add retry budgets and stop conditions
- [ ] Add prompt/output logging

## Phase 3 — Storage and workflow automation
...
- [ ] Add deterministic composition/rendering for factual overlays
